    ...
    <header role="banner">
      ...
      >
        <div class="max-w-7xl mx-auto px-6 h-[68px] flex items-center justify-between gap-8">
          ...
          >
            ...
            <li><a href="/audit" class="hover:text-ink-primary transition-colors duration-150">Free Audit</a></li>
      ...
      >
        <ul class="flex flex-col gap-1 list-none m-0 p-0" role="list">
          ...
          <li>
            <a href="/audit" class="block py-3 px-4 text-xl font-display font-semibold text-ink-primary rounded-lg hover:bg-surface-elevated transition-colors mobile-nav-link">
              Free Audit
            </a>
          </li>
          <li>
